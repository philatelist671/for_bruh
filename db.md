...
- system-ctl — доступна не во всех дистрибутивах, но имеет широкие возможности,
...
В них не работает экранирование. Поместить в строку кавычку можно, удвоив её: ```'User''s name'``` задаёт строку ```User's name```. Привычное экранирование работает, если предварить литерал буквой E:
```sql
